...
app.Animation = (function () {
	...
	function initialize() {
        ...
        t.set("#caption-2b", {opacity:0});
		t.set("#caption-3", {opacity:0});
		t.set("#caption-4", {opacity:0});
		t.set("#caption-5", {opacity:0, y:-50});
        // t.set("#caption-6", {opacity:0, y:-50});
	...
	function step2() {
		...
		t.delayedCall(1.3, step2b);
	}

    // --------------------------------------------------------------------------------------
    function step2b() {
        t.to("#caption-2", 0, {opacity:0, delay:0.0, ease:Cubic.easeInOut});
        t.to("#caption-2b", 0, {opacity:1, delay:0.0, ease:Cubic.easeInOut});
        t.delayedCall(1.3, step3);
    }

	// --------------------------------------------------------------------------------------
	function step3() {
		t.to("#caption-2b", 0, {opacity:0, delay:0.0, ease:Cubic.easeInOut});

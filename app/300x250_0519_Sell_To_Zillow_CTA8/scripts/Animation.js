...
app.Animation = (function () {
	...
	function initialize() {
        ...
        t.set("#caption-6", {opacity:0, y:20});
	...
	// --------------------------------------------------------------------------------------
	function step5() {
		t.to("#caption-4", 1, {opacity:0, delay:0.0, ease:Cubic.easeInOut});
		t.to("#caption-5", 1, {opacity:1, delay:0.5, ease:Cubic.easeInOut});
    ...
    function step6() {
        ...
        t.to("#caption-6", 1, {opacity:1, delay:0.5, ease:Cubic.easeInOut});
        t.delayedCall(2, step7);
    }

	// --------------------------------------------------------------------------------------
	function step7() {
		// t.to("#caption-6", 1, {y:20, delay:0.0, ease:Cubic.easeInOut});
